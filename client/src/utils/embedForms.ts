...
export const EMBED_FORMS = {
  // Contact page form
  CONTACT_FORM: `<iframe src="https://e40479db-edfd-4265-9a8b-1e462b5725d1-00-290zw6wfwpbn.picard.replit.dev/embed/form/4" width="100%" height="650" frameborder="0" scrolling="no" style="border: none; border-radius: 8px; overflow: hidden;"></iframe>`,
