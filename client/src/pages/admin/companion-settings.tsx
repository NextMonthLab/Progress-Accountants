            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  {companionConfig.tone.examplePhrases.map((phrase, index) => (
              ...
              <div>
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  {companionConfig.allowedTopics.map((topic, index) => (
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  {companionConfig.offlimitTopics.map((topic, index) => (
                    <li key={index}>{topic}</li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                ...
                {companionConfig.dataAccess.customDataSources.length > 0 && (
                  <>
                    ...
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                      {companionConfig.dataAccess.customDataSources.map((source, index) => (
