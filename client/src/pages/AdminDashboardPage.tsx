    ...
    <Card className={`overflow-hidden border border-l-4 ${
      ...
      <div className={`${scheme[color].bg} p-4 sm:p-6`}>
        <div className="flex justify-between items-center">
          ...
          <div className={`w-12 h-12 rounded flex items-center justify-center ${scheme[color].icon} transition-transform duration-200 hover:scale-110`}>
            {icon}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex gap-4 py-4 border-b border-gray-100 dark:border-gray-800 last:border-0">
      {isLoading ? (
        ...
        <>
          <div className="h-10 w-10 rounded bg-[#008080]/10 dark:bg-[#008080]/20 flex items-center justify-center text-[#008080] dark:text-[#4fd1d1]">
            {icon}
          </div>
