          ...
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <FadeIn delay={0.1}>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight"
                ...
                <span className="block">Cloud Accounting.</span>
            ...
            <FadeIn delay={0.2}>
              <p className="text-lg sm:text-xl md:text-2xl text-gray-200 mb-8 max-w-2xl mx-auto"
                ...
                Modern cloud technology with real-time visibility and automated workflows for growing businesses.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <button
                ...
                aria-label="Book a strategy consultation for cloud accounting services"
              >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold">
                <span className="text-white">Modern Cloud Accounting</span>
              </h2>
            </div>
