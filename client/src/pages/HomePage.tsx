                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-6 border-b border-slate-600/50 pb-6">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <a href="tel:01234567890" className="text-slate-400 hover:text-[#7B3FE4] transition-colors p-2 rounded-lg hover:bg-slate-800/50">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="space-y-3 text-slate-300">
                              ...
                              <div>
                                ...
                                <a href="tel:01234567890" className="text-[#3FA4E4] hover:text-[#7B3FE4] transition-colors text-sm">
                                  01234 567 890
                                </a>
                              </div>
                            </div>
