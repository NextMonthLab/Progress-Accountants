...
/**
 * Simple Entrepreneur Support Page
 */
const EntrepreneurSupportPage = () => {
  return (
    <AdminLayout>
      <div className="container mx-auto px-4 py-6">
        <h1 className="text-3xl font-bold mb-6">Entrepreneur Support Hub</h1>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-4">
                ...
                <li>
                  <h3 className="font-semibold">Growing Your Business Without Hiring</h3>
                  <p className="text-sm text-muted-foreground">
                    Strategies to scale your operations while staying lean.
                  </p>
                </li>
              </ul>
            </CardContent>
