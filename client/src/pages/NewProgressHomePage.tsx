...
import { Calendar, Clock, MapPin, Users, Play, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800">
      ...
      <nav className="flex items-center justify-between p-6 bg-black/20 backdrop-blur-sm">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-purple-300 text-sm">Accountants | Business Growth Specialists</span>
        </div>
        
        <div className="hidden md:flex items-center space-x-8">
          <Link href="/" className="text-white hover:text-purple-300 transition-colors">Home</Link>
          <Link href="/studio" className="text-white hover:text-purple-300 transition-colors">Video</Link>
          <Link href="/services" className="text-white hover:text-purple-300 transition-colors">Experience</Link>
          <Link href="/network" className="text-white hover:text-purple-300 transition-colors">Networking</Link>
