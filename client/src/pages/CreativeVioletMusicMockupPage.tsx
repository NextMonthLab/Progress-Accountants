...
const CreativeVioletMusicMockupPage = () => {
  return (
          ...
          <div className="md:w-1/2">
            <SlideInLeft>
              <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ color: colors.text }}>
                Expert Financial Services for the Music Industry
              </h1>
              ...
              <p className="text-lg mb-8 leading-relaxed" style={{ color: colors.lightText }}>
                ...
                maximize revenue, minimize tax liability, and focus on your creative passion.
              </p>
              ...
              <div className="absolute -bottom-6 -right-6 rounded-lg p-4 shadow-lg z-10 max-w-[260px]" style={{ backgroundColor: 'white' }}>
                <div className="flex">
                  <div className="mr-3 flex-shrink-0">
                    <div className="rounded-full p-2" style={{ backgroundColor: colors.accent, color: 'white' }}>
                      <Music className="h-6 w-6" />
                    </div>
                  </div>
                  <div>
                    <p className="font-semibold" style={{ color: colors.text }}>Recording Studio Tax Relief</p>
                    <p className="text-sm text-gray-600">Save up to 25% on studio investments</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mb-16">
            <ScaleIn>
              ...
              <p className="max-w-3xl mx-auto" style={{ color: colors.lightText }}>
                The music industry has unique financial challenges and opportunities. Our team has expertise in all areas of music business accounting.
              </p>
            </ScaleIn>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <SlideUp delay={0.1}>
              <Card className="h-full transition-all duration-300 hover:shadow-lg" style={{ borderColor: colors.border }}>
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold mb-3" style={{ color: colors.text }}>Royalty Accounting</h3>
                  <p className="mb-4" style={{ color: colors.lightText }}>
                    Accurate tracking and auditing of royalty payments across multiple revenue streams and platforms.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                      <span className="text-sm" style={{ color: colors.lightText }}>Streaming platform reconciliation</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                      <span className="text-sm" style={{ color: colors.lightText }}>Revenue analysis and forecasting</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                      <span className="text-sm" style={{ color: colors.lightText }}>Contract review and optimization</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            <SlideUp delay={0.2}>
              <Card className="h-full transition-all duration-300 hover:shadow-lg" style={{ borderColor: colors.border }}>
                <CardContent className="p-6">
                  <div className="p-3 rounded-full w-fit mb-4" style={{ backgroundColor: colors.highlight }}>
                    <Disc className="h-6 w-6" style={{ color: colors.accent }} />
                  </div>
                  <h3 className="text-xl font-bold mb-3" style={{ color: colors.text }}>Tour & Performance Accounting</h3>
                  <p className="mb-4" style={{ color: colors.lightText }}>
                    Comprehensive financial management for tours, live events, and performances in multiple territories.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                      <span className="text-sm" style={{ color: colors.lightText }}>International VAT recovery</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                      <span className="text-sm" style={{ color: colors.lightText }}>Tour budget management</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                      <span className="text-sm" style={{ color: colors.lightText }}>Merchandise accounting</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            <SlideUp delay={0.3}>
              <Card className="h-full transition-all duration-300 hover:shadow-lg" style={{ borderColor: colors.border }}>
                <CardContent className="p-6">
                  <div className="p-3 rounded-full w-fit mb-4" style={{ backgroundColor: colors.highlight }}>
                    <CreditCard className="h-6 w-6" style={{ color: colors.accent }} />
                  </div>
                  <h3 className="text-xl font-bold mb-3" style={{ color: colors.text }}>Tax Planning Strategies</h3>
                  <p className="mb-4" style={{ color: colors.lightText }}>
                    Specialized tax services for music businesses, creators, and performers to minimize liabilities.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                    ...
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                      <span className="text-sm" style={{ color: colors.lightText }}>Equipment investment allowances</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 mr-2 flex-shrink-0" style={{ color: colors.accent }} />
                      <span className="text-sm" style={{ color: colors.lightText }}>Optimized business structures</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <FadeIn>
              ...
              <p className="max-w-3xl mx-auto" style={{ color: colors.lightText }}>
                See how we helped a leading independent record label optimize their financial operations and save £175,000 in tax.
              </p>
            </FadeIn>
          </div>
            ...
            <div className="md:w-1/2 mt-8 md:mt-0" style={{ color: colors.text }}>
              <SlideInRight>
                <h3 className="text-2xl font-bold mb-6">
                  £175,000 Tax Savings for Sunrise Records
                </h3>
                <p className="mb-6">
                  Sunrise Records, an independent UK label with 15 artists, was struggling with complex royalty accounting and tax liabilities affecting their growth.
                </p>
                <div className="space-y-4 mb-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p>Complex international royalty streams and high tax burden limiting reinvestment potential</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="p-2 rounded-full mr-3" style={{ backgroundColor: colors.accent, color: 'white' }}>
                    ...
                    <div>
                      ...
                      <p>Implemented automated royalty tracking system and optimized corporate structure</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="p-2 rounded-full mr-3" style={{ backgroundColor: colors.accent, color: 'white' }}>
                    ...
                    <div>
                      ...
                      <p>£175,000 in tax savings, 30% increase in artist royalty accuracy, and expanded operations</p>
                    </div>
                  </div>
                </div>
                <Button 
            ...
            <div className="md:w-1/2">
              <SlideInLeft>
                <h2 className="text-3xl font-bold mb-6" style={{ color: colors.text }}>
                  Our Music Industry Specialists
                </h2>
                <p className="mb-6" style={{ color: colors.lightText }}>
                  ...
                  We understand the business from both the creative and financial perspectives.
                </p>
                <div className="space-y-4 mb-8">
                  <div className="flex items-center">
                    <User className="h-5 w-5 mr-3" style={{ color: colors.accent }} />
                    <span style={{ color: colors.text }}>Sarah Thompson, Head of Music Industry Services</span>
                  </div>
                  <div className="flex items-center">
                    <User className="h-5 w-5 mr-3" style={{ color: colors.accent }} />
                    <span style={{ color: colors.text }}>David Chen, Royalty Accounting Specialist</span>
                  </div>
                  <div className="flex items-center">
                    <User className="h-5 w-5 mr-3" style={{ color: colors.accent }} />
                    <span style={{ color: colors.text }}>Maria Rodriguez, Tour Finance Manager</span>
                  </div>
                </div>
                <Button 
                  variant="outline" 
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <FadeIn>
              ...
              <p className="max-w-3xl mx-auto" style={{ color: colors.lightText }}>
                We've helped artists, producers, and music businesses across the UK optimize their finances.
              </p>
            </FadeIn>
          </div>
              ...
              <Card className="h-full" style={{ borderColor: colors.border }}>
                <CardContent className="p-6">
                  ...
                  <p className="italic mb-6" style={{ color: colors.lightText }}>
                    "Progress Accountants transformed our royalty tracking system. We now have complete clarity on our income streams and saved significant tax. Their music industry knowledge is exceptional."
                  </p>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm" style={{ color: colors.lightText }}>CEO, Marble Studios</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <SlideUp delay={0.2}>
              <Card className="h-full" style={{ borderColor: colors.border }}>
                <CardContent className="p-6">
                  ...
                  <p className="italic mb-6" style={{ color: colors.lightText }}>
                    "As an independent artist, managing finances was overwhelming. The team at Progress created a streamlined system that lets me focus on my music while maximizing my earnings and minimizing tax."
                  </p>
                  <div className="flex items-center">
                    <div className="rounded-full w-12 h-12 bg-gray-300 mr-4" style={{ backgroundColor: colors.highlight }}></div>
                    <div>
                      <p className="font-semibold" style={{ color: colors.text }}>Elena Frost</p>
            ...
            <SlideUp delay={0.3}>
              <Card className="h-full" style={{ borderColor: colors.border }}>
                <CardContent className="p-6">
                  ...
                  <p className="italic mb-6" style={{ color: colors.lightText }}>
                    "Progress Accountants helped us navigate complex international tax issues during our European tour. Their expertise in music touring finances saved us thousands in unnecessary tax payments."
                  </p>
                  <div className="flex items-center">
                    <div className="rounded-full w-12 h-12 bg-gray-300 mr-4" style={{ backgroundColor: colors.highlight }}></div>
                    <div>
                      <p className="font-semibold" style={{ color: colors.text }}>Michael Reed</p>
                      <p className="text-sm" style={{ color: colors.lightText }}>Tour Manager, The Resonants</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <FadeIn>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
                Ready to Optimize Your Music Business Finances?
              </h2>
              <p className="text-lg mb-8 text-white opacity-90">
                Book a free 30-minute strategy session with our music industry accounting specialists. 
                We'll analyze your current situation and identify opportunities for growth and savings.
              </p>
              ...
              <div className="bg-white p-8 rounded-lg shadow-xl">
                ...
                <div className="mb-6">
                  ...
                  <textarea 
                    ...
                    style={{ borderColor: colors.border, color: colors.text }}
                    rows={4}
                    placeholder="What financial challenges are you facing in your music business?"
                  ></textarea>
                </div>
                <Button 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="mb-4 opacity-80">
                Specialized financial services for the music industry and creative professionals.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 opacity-80">
                <li><a href="#" className="hover:opacity-100">Royalty Accounting</a></li>
                <li><a href="#" className="hover:opacity-100">Tour Accounting</a></li>
                <li><a href="#" className="hover:opacity-100">Tax Planning</a></li>
                <li><a href="#" className="hover:opacity-100">Financial Management</a></li>
                <li><a href="#" className="hover:opacity-100">Business Planning</a></li>
              </ul>
            </div>
...
export default CreativeVioletMusicMockupPage;