...
import { generateBusinessCalculatorPDF } from "@/utils/pdfGenerator";
import { z } from "zod";
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    ...
                    element.download = 'progress-business-analysis-report.pdf';
                    ...
                    toast({ title: "Download complete", description: "Your branded business analysis report has been downloaded." });
                  } catch (error) {
