            ...
            <div className="space-y-3">
              {deadlines && deadlines.length > 0 ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm mt-1">All priority items are up to date</p>
                </div>
              )}
            </div>
          </CardContent>
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {deadlines && deadlines.length > 0 ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm mt-1">Your timeline is clear</p>
                </div>
              )}
            </div>
          </CardContent>
        ...
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            ...
            <div className="p-4 bg-orange-50 rounded-lg">
              <p className="text-2xl font-bold text-orange-600">{summary?.highCount || 0}</p>
              <p className="text-sm text-gray-600">High Priority</p>
            </div>
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-2xl font-bold text-blue-600">{summary?.mediumCount || 0}</p>
              <p className="text-sm text-gray-600">Medium Priority</p>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              <p className="text-2xl font-bold text-green-600">{summary?.lowCount || 0}</p>
